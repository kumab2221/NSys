...
int main(int argc, char* argv[])
{
    ...
    ::RegisterClassExW(&wc);
    HWND hwnd = ::CreateWindowW(wc.lpszClassName, L"NSys", WS_OVERLAPPEDWINDOW, 100, 100, 1280, 800, nullptr, nullptr, wc.hInstance, nullptr);
    ...
    while (!done)
    {
...

        {
            ...
            // メニューバーの高さを取得し、Docking Spaceの位置を調整
            float menu_bar_height = ImGui::GetFrameHeight(); // メニューバーの高さ
